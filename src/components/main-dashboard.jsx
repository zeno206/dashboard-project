      ...
      <div className="div-2">
        ...
        <div className="bx-3">
          <div className="txt">
            ...
            <h4 className="sale">
              <span className="span">-23%</span>Since last month
            </h4>
          </div>
        </div>
        <div className="bx-4">
          ...
          <div className="icn">
            <img
              className="usa"
              src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRXN8Bs7jGwN8GUOAGfNYZhon7uPKxDRFAt_A&s"
              alt=""
            />
          </div>
        </div>
        <div className="bx-5">
          <div className="icn">
            <img
              className="right"
              src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSHOZGHRzbJTkWcZaotwdW45CW6wKigTqvHpQ&s"
              alt=""
            />
          </div>
          <div className="txt">
        ...
        <div className="bigbox-1">
          ...
          <div className="line-2">
            <div className="l-3">
              ...
              <h6 className="hh6">
                <i class="ri-grok-ai-line"></i>ON TREK
              </h6>
            </div>
            <div className="l-4">
